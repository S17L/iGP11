...
namespace direct3d11 {
	...
	namespace utility {
        ...
        dto::GaussianBlurConfiguration getGaussianBlurConfiguration(float smoothness);
        dto::RenderingResolution getRenderingResolution(ID3D11Texture2D *texture);
        dto::RenderingResolution getRenderingResolution(IDXGISwapChain *chain);
