...
namespace direct3d11 {
    ...
    private:
        ...
        std::unique_ptr<ShaderApplicator> _cocShaderApplicator;
        std::unique_ptr<ShaderApplicator> _blurPassFirstShaderApplicator;
        std::unique_ptr<ShaderApplicator> _blurPassSecondShaderApplicator;
        std::unique_ptr<ShaderApplicator> _blurPassThirdShaderApplicator;
        std::unique_ptr<ShaderApplicator> _chromaticAberrationShaderApplicator;
        std::unique_ptr<ShaderApplicator> _horizontalGaussianBlurShaderApplicator;
        std::unique_ptr<ShaderApplicator> _verticalGaussianBlurShaderApplicator;
        std::unique_ptr<ShaderApplicator> _blendingShaderApplicator;
